  ...
  app.get("/scrape-sites", async (req, res) => {
    try {
      ...
      let costco = await axios.get(
        "https://laptop-scrape.herokuapp.com/https://www.costco.com/laptops.html?operating-system=windows-os&screen-size=173-in&refine=ads_f117501_ntk_cs%253A%2522Windows%2BOS%2522|ads_f142505_ntk_cs%253A%252217.3%2Bin.%2522|"
      );
